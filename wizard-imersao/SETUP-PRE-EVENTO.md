...
> Responsáveis: Flávia + Hugo. Marcar cada item conforme concluído.
...
- [ ] Preparar mensagem da Flávia para postar nas pausas
...
- [ ] Flávia: entrar no chat como moderadora — testar que consegue postar
...
- [ ] Horário sincronizado com Flávia via mensagem às 8h55
...
| Streaming cai (Zoom/StreamYard) | Backup: reiniciar streaming em 3min; Flávia avisa no chat com horário de retorno |
| Internet cai | Hotspot celular pré-configurado — testar antes. Flávia assume comunicação com participantes |
| Flávia precisa sair | Hugo continua sozinho — moderar chat e apresentar simultaneamente |
