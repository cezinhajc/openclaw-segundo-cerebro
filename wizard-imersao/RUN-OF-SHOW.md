...
> Documento operacional para o produtor (Flávia). Imprimir 1 página por dia.

---

## DIA 1 — 28/03/2026

| Hora  | Duração | Bloco              | O que acontece                                                          | Visual                          | Ação do Flávia                              |
|-------|---------|--------------------|-------------------------------------------------------------------------|---------------------------------|-------------------------------------------|
| 9:00  | 15min   | Abertura           | Boas-vindas, apresentar Hugo+Flávia, explicar formato sem slides, ativar chat com pergunta "Qual área automatizar?" | `apresentacao-imersao-v3.html` → capa | Confirmar transmissão OK, contagem de participantes, moderar chat |
...
| 9:39  | 25min   | Bloco 2            | Tour completo pelo `cerebro/`, abrir SOUL.md + AGENTS.md, demo dupla OpenClaw+Claude Code com mesma pergunta, interação com chat | Terminal: `tree cerebro/` + arquivos abertos | Passar perguntas do chat para Hugo; anotar top 3 para Bloco 4 |
...
| 10:35 | 5min    | _Transição/Buffer_ | Hugo responde 1 pergunta rápida do chat enquanto prepara ambiente Bloco 4 | —                               | Postar mensagem de pausa no chat: "☕ Pausa de 10 min. Volta 10h40 com 2º AHA." |
| 10:40 | 10min   | **Pausa**          | Descanso — Hugo. Flávia coleta top 3 perguntas do chat                  | —                               | Coletar top 3 perguntas; testar skill-creator pronto; postar no chat |
| 10:50 | 1min    | _Retorno_          | Hugo de volta ao ar, confirmar áudio/vídeo                             | Terminal                        | Confirmar qualidade stream                |
| 10:51 | 35min   | Bloco 4 🔥         | Responder top 3 perguntas (5min), apresentar skill-creator, criar skill com linguagem natural, criar skill baseada em sugestão do chat — **2º AHA MOMENT** | Terminal ao vivo                | Escolher sugestão mais interessante do chat para Hugo criar ao vivo |
...
| Hora  | Duração | Bloco              | O que acontece                                                          | Visual                          | Ação do Flávia                              |
|-------|---------|--------------------|-------------------------------------------------------------------------|---------------------------------|-------------------------------------------|
| 9:00  | 15min   | Abertura Dia 2     | Recap Dia 1 em 5 bullets, coletar tarefas que participantes pensaram, roteiro do Dia 2, reativar engajamento | Terminal: recap rápido          | Confirmar ambiente OK; monitorar chat; selecionar 2-3 respostas para Hugo ler |
...
| 10:41 | 1min    | _Transição/Buffer_ | Hugo responde 1 pergunta rápida                                        | —                               | Postar no chat: "☕ Última pausa. Volta 10h50 com o maior AHA MOMENT da imersão." |
| 10:42 | 8min    | **Pausa**          | Descanso. Flávia testa bot de suporte demo ao vivo                       | —                               | Testar: faq.md + duvidas.md + skill consolidar-faq; confirmar Telegram do bot OK |
| 10:50 | 1min    | _Retorno_          | Hugo de volta, confirmar áudio                                         | —                               | Confirmar stream OK                       |
...
| _Itálico_ | Transição — Hugo prepara ambiente, não fala |
