...
- Marcar @Hugo quando não sei a resposta

## O que sempre escalo para o Hugo ⚠️
...
1. **Base de conhecimento** (`cerebro/areas/atendimento/bot/base-conhecimento.md`) — tudo que o bot já sabe: FAQ + respostas validadas pelo Hugo

Se não tem a resposta na base → respondo o que sei + marco @Hugo + registro em `duvidas-pendentes.md`.
