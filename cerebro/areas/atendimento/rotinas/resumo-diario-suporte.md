...
> Gera e envia o relatório diário de suporte pro Hugo via Telegram.
...
2. **Enviar resultado** via Telegram Bot API pro Hugo
...
- **Formato consistente** — sempre o mesmo template pra Hugo criar padrão visual

## Output

- Mensagem no Telegram do Hugo (via skill relatorio-suporte)
