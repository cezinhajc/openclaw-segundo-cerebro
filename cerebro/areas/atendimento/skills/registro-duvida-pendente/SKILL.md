...
> Registra dúvidas que o bot não sabe responder e escala pro Hugo.
...
2. **Marcar @Hugo** na conversa com a dúvida específica
3. **Registrar no Supabase** — tabela `duvidas-pendentes`:
   ...
   - Status: `pendente`
   - Data de registro
4. **Avisar o aluno**: "Vou verificar com o Hugo e te retorno"
