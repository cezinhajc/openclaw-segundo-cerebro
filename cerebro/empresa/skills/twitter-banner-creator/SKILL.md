...
do X (Twitter). Este é o formato padrão de criativo usado nas campanhas da Idens.
...
- **Avatar:**
  ...
  - Arquivo padrão: `criativos/Assets/autor-padrao.jpg`
...
run(
    banners=banners,
    avatar_path=Path("{projeto}/criativos/Assets/autor-padrao.jpg"),
...
## Dados do autor (padrão Idens)

- **Nome:** Hugo Dória
- **Handle:** @brunomicrossaas
- **Avatar:** `criativos/Assets/autor-padrao.jpg`
- **Verificado:** sim (selo azul do X)

Esses dados são fixos pra todos os criativos da Idens. Se for outro
...
- [ ] Avatar 72×72px circular com foto do autor padrão
