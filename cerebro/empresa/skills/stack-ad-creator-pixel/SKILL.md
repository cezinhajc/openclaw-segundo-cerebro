...
description: Gerar banners estáticos de Meta Ads no formato "stack" da Idens — fundo escuro #0A0E2A, mascote OpenClaw, hero badge, H1 bold, subtítulo, 3 cards de benefício numerados e price card laranja arredondado. Dois formatos: Post 4:5 (1080×1350) e Story 9:16 (1080×1920). Usar quando Flávia pedir para criar banners de produto, anúncios estáticos da marca, criativos no formato stack, ou qualquer banner com cards de benefício + preço no estilo da marca configurada.
---

# Stack Ad Creator — Idens
